    ...
    public static class DummyData
    {
        public static void Create()
        {
            Db.Transact(() =>
            {
                ...
                {
                    new Person { Name = "Person 1", orderNr = 1 };
                    new Person { Name = "Person 2", orderNr = 2 };
                    new Person { Name = "Person 3", orderNr = 3 };
                    new Person { Name = "Person 4", orderNr = 4 };
                    new Person { Name = "Person 5", orderNr = 5 };
                }
            });
        }
    }
